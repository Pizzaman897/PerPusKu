...
<head>
    ...
    <title>Edit Murid - PerPusKu</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <div class="w-full rounded-2xl bg-white p-10 shadow-sm">
                ...
                <h1 class="mb-8 text-3xl font-extrabold text-[#051541]">Edit Murid</h1>
                ...
                <form method="POST" action="{{ route('admin.kelola-murid.update', $student['id']) }}" class="max-w-xl space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="status_pinjam" id="status_pinjam"
                            ...
                            <option value="dipinjam" {{ old('status_pinjam', $student['status_pinjam']) === 'dipinjam' ? 'selected' : '' }}>Sedang Meminjam</option>
                            <option value="tidak_dipinjam" {{ old('status_pinjam', $student['status_pinjam']) === 'tidak_dipinjam' ? 'selected' : '' }}>Tidak Meminjam</option>
                        </select>
                    </div>
