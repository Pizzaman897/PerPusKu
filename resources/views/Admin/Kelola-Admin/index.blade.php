    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <h1 class="text-3xl font-extrabold text-[#051541]">Kelola Admin</h1>
                ...
                <table class="w-full text-left">
                    ...
                    <tbody>
                        @forelse ($admins as $index => $admin)
                            <tr class="{{ $index % 2 === 1 ? 'bg-[#EDF1FD]/60' : 'bg-white' }}">
                                <td class="px-6 py-4 font-semibold text-[#051541]">
                                    {{ $admins->firstItem() + $index }}.
                                </td>
                                <td class="px-6 py-4 text-gray-800">
                                    <a href="{{ route('admin.kelola-admin.show', $admin) }}" class="hover:text-[#4748D9] hover:underline">
                                        {{ $admin->name }}
                                    </a>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-3">
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('admin.kelola-admin.edit', $admin) }}"
