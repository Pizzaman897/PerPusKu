...
<head>
    ...
    <title>Detail Admin - PerPusKu</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <div class="w-full rounded-2xl bg-white p-10 shadow-sm">
                ...
                <h1 class="mb-8 text-3xl font-extrabold text-[#051541]">Detail Admin</h1>

                <div class="max-w-xl space-y-6">
                    <div>
                        <span class="mb-2 block text-base font-bold text-[#051541]">Admin</span>
                    ...
                    <div>
                        <span class="mb-2 block text-base font-bold text-[#051541]">Terdaftar Sejak</span>
                        <div class="w-full rounded-lg border-2 border-[#051541] bg-[#EDF1FD] px-4 py-3 text-base text-[#051541]">
