...
<head>
    ...
    <title>Edit Admin - PerPusKu</title>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-8">
            <div class="w-full rounded-2xl bg-white p-10 shadow-sm">
                ...
                <h1 class="mb-8 text-3xl font-extrabold text-[#051541]">Edit Admin</h1>
                ...
                <form method="POST" action="{{ route('admin.kelola-admin.update', $admin) }}" class="max-w-xl space-y-6">
                    @csrf
                    @method('PUT')
